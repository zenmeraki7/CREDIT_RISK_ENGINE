...
# =============================================================================
# LEGACY RISK SCORE (0-100, penalty-based, used by make_loan_decision)
# =============================================================================
...
def calculate_risk_score(
    ...
    """
    Legacy rule-based risk score (0-100).
    Called by make_loan_decision().
...
def make_loan_decision(
    ...
    """
    Legacy standalone decision function (used when ML model is unavailable).
