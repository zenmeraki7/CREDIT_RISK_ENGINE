...
:root {
    ...
    --bg-main: #F0F9FF;                /* very light sky blue background */
    --card-bg: #FFFFFF;                 /* white cards */
    --text-primary: #1E293B;            /* dark slate for softer text */
    --text-secondary: #64748B;           /* softer grey for labels */
    --border-soft: #E2E8F0;              /* very light border */
    --light-bg: #E6F3FF;                  /* slightly darker blue for subtle backgrounds (e.g., hover) */
