...
# # Add necessary paths to import local modules
# # notebooks folder (for css_styles, stage2_engine, etc.)
...
#         customer_data = {
#             'age': age, 'employment_type': employment_type, 'kyc_verified': kyc_verified,
...
#                                  {"Age": age, "Employment": employment_type,
